...
XiaoYi = XiaoYiJiang.XiaoYiJiang(config["CORPID"],config["CORPSECRET"],config["AGENTID"],config["TOUSER"],scriptFolderPath,ana=config["XiaoYi"]["ana"],nickname=config["XiaoYi"]["nickname"],morningGreeting=config["XiaoYi"]["morningGreeting"])
